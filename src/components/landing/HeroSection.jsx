      ...
      <div className="max-w-6xl mx-auto px-4 sm:px-6 pt-10 pb-0">
        <div className="flex justify-center">
          <div className="w-full max-w-3xl text-center z-10">
            ...
            <div className="w-10 h-1 bg-[#2D6A2F] rounded-full mb-4 mx-auto" />
            <p className="text-[#444444] text-base sm:text-lg leading-relaxed max-w-2xl mx-auto mb-8">
            ...
            <div className="max-w-2xl mx-auto mb-8 rounded-xl border border-[#003B7A]/20 bg-[#F4F8FC] px-4 py-3 text-sm text-[#173B5E]">
